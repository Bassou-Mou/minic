...
public interface MiniCParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by the {@code instructionFonctionLocale}
	 * labeled alternative in {@link MiniCParser#instruction}.
	 * @param ctx the parse tree
	 */
	void enterInstructionFonctionLocale(MiniCParser.InstructionFonctionLocaleContext ctx);
	/**
	 * Exit a parse tree produced by the {@code instructionFonctionLocale}
	 * labeled alternative in {@link MiniCParser#instruction}.
	 * @param ctx the parse tree
	 */
	void exitInstructionFonctionLocale(MiniCParser.InstructionFonctionLocaleContext ctx);
	/**
