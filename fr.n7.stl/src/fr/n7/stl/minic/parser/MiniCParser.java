...
public class MiniCParser extends Parser {
	...
	public static final int
		...
		Enumeration=20, Nouveau=21, Principal=22, TantQue=23, Asterisque=24, Oblique=25, 
		PourCent=26, Plus=27, Moins=28, DoubleBarre=29, DoubleEsperluette=30, 
		PointExclamation=31, Inferieur=32, Superieur=33, InferieurEgal=34, SuperieurEgal=35, 
		DoubleEgal=36, ExclamationEgal=37, Esperluette=38, TypeEntier=39, TypeFlottant=40, 
		TypeBooleen=41, TypeCaractere=42, TypeChaine=43, TypeVide=44, Vrai=45, 
		Faux=46, Nul=47, Premier=48, Second=49, Caractere=50, Chaine=51, Identificateur=52, 
		Entier=53, Flottant=54, CommentaireLigne=55, CommentaireBloc=56, WS=57;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'typedef'", "'struct'", "'enum'", "'new'", "'main'", "'while'", "'*'", 
			"'/'", "'%'", "'+'", "'-'", "'||'", "'&&'", "'!'", "'<'", "'>'", "'<='", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"Nouveau", "Principal", "TantQue", "Asterisque", "Oblique", "PourCent", 
	...
	public final BlocContext bloc() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 4538238565572624L) != 0)) {
				{
				{
				setState(43);
	...
	@SuppressWarnings("CheckReturnValue")
	public static class InstructionFonctionLocaleContext extends InstructionContext {
		public TypeContext type() {
			return getRuleContext(TypeContext.class,0);
		}
		...
		public InstructionFonctionLocaleContext(InstructionContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof MiniCParserListener ) ((MiniCParserListener)listener).enterInstructionFonctionLocale(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof MiniCParserListener ) ((MiniCParserListener)listener).exitInstructionFonctionLocale(this);
		}
	}
	@SuppressWarnings("CheckReturnValue")
	...
	public final InstructionContext instruction() throws RecognitionException {
		...
		try {
			...
			case 7:
				...
				break;
			case 8:
				_localctx = new InstructionFonctionLocaleContext(_localctx);
	...
	public static class TypeArrayContext extends TypeContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof MiniCParserListener ) ((MiniCParserListener)listener).enterTypeArray(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof MiniCParserListener ) ((MiniCParserListener)listener).exitTypeArray(this);
		}
	}
	@SuppressWarnings("CheckReturnValue")
	...
	private TypeContext type(int _p) throws RecognitionException {
		...
		try {
			...
			case Inferieur:
				...
				match(Inferieur);
				setState(162);
				((TypeCoupleContext)_localctx).gauche = type(0);
				setState(163);
				match(Virgule);
				setState(164);
				((TypeCoupleContext)_localctx).droite = type(0);
				setState(165);
				match(Superieur);
				}
				break;
			case Enregistrement:
				...
				do {
					...
					_errHandler.sync(this);
					_la = _input.LA(1);
				} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 4538238540185600L) != 0) );
				setState(175);
				match(AccoladeFermante);
				}
				break;
	...
	public final TypesContext types() throws RecognitionException {
		...
		try {
			...
			case Identificateur:
				...
				{
				setState(329);
				((TypesContext)_localctx).type = type(0);
